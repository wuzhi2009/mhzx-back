...
public class SysUserServiceImpl implements ISysUserService, UserService {
    ...
    @Override
    public boolean updateUserInfo(SysUserBo sysUserBo, Long userId) {
        // TODO Auto-generated method stub
        if (sysUserBo.getAvatar() != null) {
            SysOss selectById = sysOssMapper.selectById(sysUserBo.getAvatar());
            if (ObjectUtil.isNull(selectById)) {
                // 上传的图片没有成功
                return false;
            }
        }
        baseMapper.updateUserInfo(sysUserBo, userId);
        return true;
    }
}
