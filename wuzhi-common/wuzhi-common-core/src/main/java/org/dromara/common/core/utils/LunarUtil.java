...
public class LunarUtil {
    ...
    final static String[] CHINESE_NUMBER = {"一", "二", "三", "四", "五", "六", "七",
            "八", "九", "十", "十一", "十二"};
     ...
     *
     * @param y 农历年份
     * @return int 若该年非闰年则返回0
     * @date 2024年10月24日 00:13:21
     */    
    ...
    /**
     * @Description: 根据提供的日期对象，返回农历字符串
     * @Param: [date]
     * @return: java.lang.String
     * @Author: xjx
     * @Date: 2023/2/23
     */
    public static String byDateResultNongLi(Date date) {
        String str = null;
        if (date == null) {
            date = new Date();
        }
